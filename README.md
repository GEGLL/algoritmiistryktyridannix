___Реализация алгоритма для генерации всех возможных сочетаний размера k из n элементов с использованием метода backtracking.___





___Алгоритм работы____
